...
# English
statusNormal_en = '<a href="{}">⁠</a>✅ Server status is normal:\n\n• Connection is {}\n• Online servers: {:,}\n• Online players: {:,}'
statusWrong_en = '❌ Something went wrong with the servers.'
# Russian
statusNormal_ru = '<a href="{}">⁠</a>✅ Сервера в нормальном состоянии:\n\n• Соединение в норме\n• Онлайн серверов: {:,}\n• Онлайн игроков: {:,}'
statusNormalSL_ru = '<a href="{}">⁠</a>✅ Сервера в нормальном состоянии:\n\n• С соединением что-то не так\n• Онлайн серверов: {:,}\n• Онлайн игроков: {:,}'
...
#Russian
notiNewMap_ru = '🆕 Официальный аккаунт CS:GO загрузил карту *{}* в Мастерскую Steam для совместимости воспроизведения демо-записей в будущих версиях игры.\n\nВ последующих обновлениях игры стоит ожидать некоторые изменения на данной карте.\n\n{}'
notiNewMaps_ru = '🆕 Официальный аккаунт CS:GO загрузил карты *{}* в Мастерскую Steam для совместимости воспроизведения демо-записей в будущих версиях игры.\n\nВ последующих обновлениях игры стоит ожидать некоторые изменения на данных картах.\n\n{}'
